...
public class HeartTransformation extends HashMap <AngleSet, String>{
	...
	public String getHeartTrans(Double a, Double b){
		try{
	...
	private void fillAngleSet(){
		...
		this.sets.add(new AngleSet(360,360));
		this.sets.add(new AngleSet(360,0));
		this.sets.add(new AngleSet(135,225));
